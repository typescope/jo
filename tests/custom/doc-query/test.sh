...
run_plain_doc --query "jo.List" > "$DIR/stdlib-list.json"
...
python3 "$DIR/assert_json.py" source-all "$DIR/all.json"
python3 "$DIR/assert_json.py" structural "$DIR/structural.json"
python3 "$DIR/assert_json.py" exact-member "$DIR/exact-member.json"
python3 "$DIR/assert_json.py" private "$DIR/private.json"
python3 "$DIR/assert_json.py" stdlib-list "$DIR/stdlib-list.json"
...
expect_fail "$FAIL_LOG" run_plain_doc --no-stdlib --query "jo.List"
rg -q "No documentation entries match symbol selector" "$FAIL_LOG"
