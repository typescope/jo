...
hljs.registerLanguage('jo', function(hljs) {
  return {
    ...
    keywords: {
      keyword: 'def data param type val var fun match case if then else with end import namespace section receives pattern allow while do begin auto defer class new alias as having private view interface',
