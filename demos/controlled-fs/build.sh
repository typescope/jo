...
CONFIG_PATH="$SCRIPT_DIR/sandbox-config"
node "$SCRIPT_DIR/init-sandbox.js" "$SANDBOX_PATH" "$CONFIG_PATH"
echo ""
...
echo "=========================================="
echo ""
node "$SCRIPT_DIR/out/app.js" "$SANDBOX_PATH" "config:$CONFIG_PATH:ro"
echo ""
echo "=========================================="
echo "Done!"
echo "=========================================="
