...
extends Linker:
  ...
  val Core_DoubleOps = Core.containerMember("DoubleOps")
  ...
  // Double primitive operators (defined in section DoubleOps in Core.jo)
  val Core_Double_add  = Core_DoubleOps.termMember("+")
  val Core_Double_sub  = Core_DoubleOps.termMember("-")
  val Core_Double_mul  = Core_DoubleOps.termMember("*")
  val Core_Double_div  = Core_DoubleOps.termMember("/")
  val Core_Double_gt   = Core_DoubleOps.termMember(">")
  val Core_Double_lt   = Core_DoubleOps.termMember("<")
  val Core_Double_ge   = Core_DoubleOps.termMember(">=")
  val Core_Double_le   = Core_DoubleOps.termMember("<=")
  val Core_Double_eq   = Core_DoubleOps.termMember("==")
  val Core_Double_ne   = Core_DoubleOps.termMember("!=")
